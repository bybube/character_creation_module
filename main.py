...
def attack(c_name, char_class):
    if char_class == 'warrior':
        return (f'{c_name} нанёс урон противнику равный {5 + randint(3, 5)}')
    if char_class == 'mage':
        return (f'{c_name} нанёс урон противнику равный {5 + randint(5, 10)}')
    if char_class == 'healer':
        return (f'{c_name} нанёс урон противнику равный {5 + randint(-3, -1)}')


def defence(c_name, char_class):
    if char_class == 'warrior':
        return (f'{c_name} блокировал {10 + randint(5, 10)} урона')
    if char_class == 'mage':
        return (f'{c_name} блокировал {10 + randint(-2, 2)} урона')
    if char_class == 'healer':
...
def start_training(c_name, char_class):
    if char_class == 'warrior':
        print(f'{c_name}, ты Воитель — отличный боец ближнего боя.')
    if char_class == 'mage':
        print(f'{c_name}, ты Маг — превосходный укротитель стихий.')
    if char_class == 'healer':
        print(f'{c_name}, ты Лекарь — чародей, способный исцелять раны.')
    ...
    while cmd != 'skip':
        ...
        if cmd == 'attack':
            print(attack(c_name, char_class))
        if cmd == 'defence':
            print(defence(c_name, char_class))
        if cmd == 'special':
            print(special(c_name, char_class))
...
if __name__ == '__main__':
    ...
    c_name = input('...назови себя: ')
    print(f'Здравствуй, {c_name}! Сейчас твоя выносливость — 80, атака — 5 и защита — 10.')
    print('Ты можешь выбрать один из трёх путей силы:')
    print('Воитель, Маг, Лекарь')
    char_class = choice_char_class()
    print(start_training(c_name, char_class))
